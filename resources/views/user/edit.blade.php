                            ...
                            <div class="container text-left" style="margin-left: 1rem; margin-right:0rem">
                                <div class="form-inline my-2">
                                    ...
                                    <div class="col-sm-6" style="padding-left: 0rem">
                                        <input type="text" placeholder="Masukin Nama" name="name" style="width: 100%" class="form-control  @error('name') is-invalid @enderror" value="{{$user->name}}">
                                        @error('name')
                                        ...
                                        <select name="role" class="form-control @error('role') is-invalid @enderror" placeholder="role" style="width: 100%">
                                            @foreach ($ketentuan as $item)
                                                @if ($item->qualifier == 'ROLE')
                                                    <option value="{{$item->code}}" {{$item->code == $user->role ? 'selected' : ''}}>{{$item->localizedName}}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                        @error('role')
                                ...
                                <div class="form-inline my-2">
                                    ...
                                    <div class="col-sm-6" style="padding-left: 0rem">
                                        <input type="email" placeholder="Masukan Email" name="email" style="width: 100%" class="form-control  @error('email') is-invalid @enderror" value="{{$user->email}}">
                                        @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-inline my-2">
                                    <label class="pl-5 col-sm-6 col-form-label">Password Baru</label>
                                    <div class="col-sm-6" style="padding-left: 0rem">
                                        <input type="password" placeholder="Masukan Password Baru" name="password" style="width: 100%" class="form-control  @error('password') is-invalid @enderror">
                                        @error('password')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <p style="margin-left: 3em; font-size: 9pt">
                                        <i>*Masukan Password bila ingin mengganti Password !</i>
                                    </p>
                                </div>
                            </div>
                        </div>
