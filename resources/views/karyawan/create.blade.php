                        ...
                        <div class="row d-flex">
                            <div class="container col-5 text-left" style="margin-left: 1rem; margin-right:0rem">
                                ...
                                <div class="form-inline my-2">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control @error('notel') is-invalid @enderror" name="notel"
                            ...
                            <div class="container col-5 text-left" style="margin-right:0rem">
                                ...
                                <div class="form-inline my-2">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="namaAyah" class="form-control @error('namaAyah') is-invalid @enderror" placeholder="Nama Ayah">
                                    @error('namaAyah')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                    </div>
                                ...
                                <div class="form-inline my-2">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="namaIbu" class="form-control @error('namaIbu') is-invalid @enderror" placeholder="Nama Ibu">
                                        @error('namaIbu')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-inline my-2">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control @error('alamatktp') is-invalid @enderror" name="alamatktp" rows="3"></textarea>
                                        @error('alamatktp')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-inline my-2">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control @error('alamatdom') is-invalid @enderror" name="alamatdom" rows="3"></textarea>
                                        @error('alamatdom')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div class="row d-flex">
                            <div class="container col-5 text-left" style="margin-left: 1rem; margin-right:0rem">
                                ...
                                <div class="form-inline my-2">
                                    <label class="col-sm-4 col-form-label">Tanggal Lahir</label>
                                    <div class="col-sm-8">
                                        <input type="date" name="dobPas" class="form-control @error('dob') is-invalid @enderror">
                                        @error('dob')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="container pl-3 pt-2" style="margin: auto">
                            ...
                            <div class="form-inline my-2">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="cabang" class="form-control @error('cabang') is-invalid @enderror" placeholder="Cabang">
                                    @error('cabang')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-inline my-2">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="noRek" class="form-control @error('noRek') is-invalid @enderror" placeholder="Nomor Rekening">
                                    @error('noRek')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-inline my-2">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="atasNama"  class="form-control @error('atasNama') is-invalid @enderror" placeholder="Atas Nama">
                                    @error('atasNama')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="container pl-3 pt-2" style="margin: auto">
                            ...
                            <div class="form-inline my-2">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="ipk" class="form-control @error('ipk') is-invalid @enderror" placeholder="IPK">
                                        @error('ipk')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                </div>
                            ...
                            <div class="form-inline my-2">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="tahunLulus" class="form-control @error('tahunLulus') is-invalid @enderror" placeholder="Tahun Ajaran">
                                        @error('tahunLulus')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="container pl-3 pt-2" style="margin: auto">
                            ...
                            <div class="form-inline my-2">
                                ...
                                <div class="col-sm-8">
                                    <select name="divisi" class="form-control @error('divisi') is-invalid @enderror">
                                        <option value="">Pilih Divis</option>
                                        @foreach ($ketentuan as $item)
                            ...
                            <div class="form-inline my-2">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="noPkwt" class="form-control @error('noPkwt') is-invalid @enderror" placeholder="Nomor PKWT">
                                        @error('noPkwt')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                </div>
